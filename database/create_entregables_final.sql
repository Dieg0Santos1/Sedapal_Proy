...
-- VERSIÓN FINAL - Con foreign keys verificadas
-- ============================================
...
RETURNS TRIGGER AS $$
BEGIN
    -- Nota: Esta función intenta eliminar el archivo del storage
    -- Si falla, no bloquea la eliminación del registro en la BD
    BEGIN
        PERFORM storage.delete_object('archivos-actividades', OLD.ruta_archivo);
    EXCEPTION WHEN OTHERS THEN
        -- Registrar el error pero permitir que continúe la eliminación
